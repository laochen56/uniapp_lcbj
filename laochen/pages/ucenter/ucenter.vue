		...
		methods: {
			...
			tapGrid(index) {
				switch (index) {
					case 0:
						uni.navigateTo({
							url: '/pages/common/webview/webview?url=' +'https://static-77a386c7-85ab-48f7-a40b-25c397281820.bspapp.com/pages/HTML/html.html'+ '&title='+'HTML'
						});
						break;
					case 1:
						uni.navigateTo({
							url: '/pages/common/webview/webview?url=' +'https://static-77a386c7-85ab-48f7-a40b-25c397281820.bspapp.com/pages/CSS/css2.html'+ '&title='+'CSS'
						});
						break;
					case 2:
						uni.navigateTo({
							url: '/pages/common/webview/webview?url=' +'https://static-77a386c7-85ab-48f7-a40b-25c397281820.bspapp.com/pages/JavaScript/js.html'+ '&title='+'JS'
						});

						break;
					case 3:
						uni.navigateTo({
							url: '/pages/common/webview/webview?url=' + 'https://static-2b5692dd-39ab-498e-b867-9a220d2bb2f2.bspapp.com'+ '&title='+'VR'
						});
						break;
				}
				// uni.showToast({
